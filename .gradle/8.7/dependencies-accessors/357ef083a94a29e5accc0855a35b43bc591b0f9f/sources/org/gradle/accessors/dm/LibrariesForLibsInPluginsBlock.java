...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final ZeeeeejLibraryAccessors laccForZeeeeejLibraryAccessors = new ZeeeeejLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>fastble</b> with <b>com.github.Jasonchenlijian:FastBle</b> coordinates and
     * with version reference <b>fastble</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getFastble() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("fastble");
    }
    ...
    /**
     * Group of libraries at <b>zeeeeej</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public ZeeeeejLibraryAccessors getZeeeeej() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForZeeeeejLibraryAccessors;
    }
    ...
    public static class KtorSerializationKotlinxLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getProtobuf() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("ktor.serialization.kotlinx.protobuf");
        }
    ...
    public static class MlkitLibraryAccessors extends SubDependencyFactory {
        ...
        private final MlkitCameraLibraryAccessors laccForMlkitCameraLibraryAccessors = new MlkitCameraLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>mlkit.camera</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public MlkitCameraLibraryAccessors getCamera() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForMlkitCameraLibraryAccessors;
        }
    ...
    public static class MlkitBarcodeLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>scanning</b> with <b>com.github.jenly1314.MLKit:mlkit-barcode-scanning</b> coordinates and
         * with version reference <b>mlkitCameraCore</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
     ...
     */
    @Deprecated
    public static class MlkitCameraLibraryAccessors extends SubDependencyFactory {

        public MlkitCameraLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>core</b> with <b>com.github.jenly1314.MLKit:mlkit-camera-core</b> coordinates and
         * with version reference <b>mlkitCameraCore</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getCore() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("mlkit.camera.core");
        }
     ...
     */
    @Deprecated
    public static class ZeeeeejLibraryAccessors extends SubDependencyFactory {
        private final ZeeeeejZhongguohongLibraryAccessors laccForZeeeeejZhongguohongLibraryAccessors = new ZeeeeejZhongguohongLibraryAccessors(owner);

        public ZeeeeejLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>zeeeeej.zhongguohong</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public ZeeeeejZhongguohongLibraryAccessors getZhongguohong() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForZeeeeejZhongguohongLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class ZeeeeejZhongguohongLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public ZeeeeejZhongguohongLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>zhongguohong</b> with <b>io.github.zeeeeej:zhongguohong</b> coordinates and
         * with version reference <b>zeeeeej</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> asProvider() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("zeeeeej.zhongguohong");
        }

        /**
         * Dependency provider for <b>compose</b> with <b>io.github.zeeeeej:zhongguohong-compose</b> coordinates and
         * with version reference <b>zeeeeej</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getCompose() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("zeeeeej.zhongguohong.compose");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>fastble</b> with value <b>2.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getFastble() { return getVersion("fastble"); }
        ...
        /**
         * Version alias <b>mlkitCameraCore</b> with value <b>1.0.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMlkitCameraCore() { return getVersion("mlkitCameraCore"); }
        ...
        /**
         * Version alias <b>zeeeeej</b> with value <b>1.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getZeeeeej() { return getVersion("zeeeeej"); }
    ...
    public static class AccompanistVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>accompanist.systemuicontroller</b> with value <b>0.31.0-alpha</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class BundleAccessors extends BundleFactory {
        ...
        /**
         * Dependency bundle provider for <b>kotlinx</b> which contains the following dependencies:
         * <ul>
         ...
         */
        @Deprecated
        public Provider<ExternalModuleDependencyBundle> getKotlinx() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return createBundle("kotlinx");
        }

        /**
         * Dependency bundle provider for <b>mlkit</b> which contains the following dependencies:
         * <ul>
         *    <li>com.github.jenly1314.MLKit:mlkit-barcode-scanning</li>
         *    <li>com.github.jenly1314.MLKit:mlkit-camera-core</li>
         * </ul>
         * <p>
         * This bundle was declared in catalog libs.versions.toml
         *
        ...
        /**
         * Dependency bundle provider for <b>zeeeeej</b> which contains the following dependencies:
         * <ul>
         *    <li>io.github.zeeeeej:zhongguohong</li>
         *    <li>io.github.zeeeeej:zhongguohong-compose</li>
         * </ul>
         * <p>
         * This bundle was declared in catalog libs.versions.toml
         *
         ...
         */
        @Deprecated
        public Provider<ExternalModuleDependencyBundle> getZeeeeej() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return createBundle("zeeeeej");
        }
